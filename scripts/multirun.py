...
subprocess.run(['bash', '/mai_nas/BYS/glioma/scripts/run_train_idh.sh', 'resnet50', '75', '7531'])
subprocess.run(['bash', '/mai_nas/BYS/glioma/scripts/run_train_idh.sh', 'vit_base', '75', '7531'])
subprocess.run(['bash', '/mai_nas/BYS/glioma/scripts/run_train_1p19q.sh', 'resnet50', '75', '3456'])
subprocess.run(['bash', '/mai_nas/BYS/glioma/scripts/run_train_1p19q.sh', 'vit_base', '75', '3456'])
